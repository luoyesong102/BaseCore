...
using SAAS.Dapper.Extension.Core.Interfaces;
using SAAS.Dapper.Extension.Helper;

namespace SAAS.Dapper.Extension.Core.SetQ
{
    /// <summary>
    /// 查询集
    /// </summary>
    ...
    public class QuerySet<T> : Aggregation<T>, IQuerySet<T>
    {
        ...
        public QuerySet(IDbConnection conn, SqlProvider sqlProvider, Type tableType,IDbTransaction dbTransaction) : base(conn, sqlProvider, dbTransaction)
        {
