...
namespace SAAS.Dapper.Extension.Core.SetC
{
    /// <summary>
    /// 指令集
    /// </summary>
    ...
    public class CommandSet<T> : Command<T>, ICommandSet<T>
    {
        ...
        public CommandSet(IDbConnection conn, SqlProvider sqlProvider, Type tableType, LambdaExpression whereExpression) : base(sqlProvider, conn)
        {
