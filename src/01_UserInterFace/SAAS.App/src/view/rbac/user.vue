  ...
  methods: {
    loadUserList() {
      getUserList(this.stores.user.query).then(res => {
        debugger
        this.stores.user.data = res.data.data.body;
        this.stores.user.query.totalCount = res.data.data.count;
      });
    },
    ...
    handleSortChange(column) {
      this.stores.user.query.SortCol = column.order;
      this.stores.user.query.OrderBy = column.key;
      this.loadUserList();
    },
    handlePageChanged(page) {
      debugger
      this.stores.user.query.PageIndex = page;
      this.loadUserList();
    },
       ...
       debugger
        var result =JSON.parse(res.data.data);
         console.log(result.roles);
            console.log(result.assignedRoles);
    ...
    handleAssignRole(row) {
      ...
      this.formAssignRole.userId = row.id;
      this.loadUserRoleList(row.id);
    },
    handleSaveUserRoles() {
      var data = {
        userId: this.formAssignRole.userId,
